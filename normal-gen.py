...
#     config = GPT2Config.from_pretrained(test_model_path)
#     model = VQPassGPTModel(config)
#     model.load_state_dict(torch.load(os.path.join(test_model_path, "pytorch_model.bin"), map_location="cpu"))
